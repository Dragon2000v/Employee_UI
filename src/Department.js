...
export class Department extends Component{
    ...
    <tbody>
     ...
     <Modal show={!!modalTitle} onHide={() => this.setState({ modalTitle: "" })}>
                    <Modal.Header closeButton>
                        <Modal.Title>{modalTitle}</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Form.Group as={Row} controlId="formDepartmentName">
                            <Form.Label column sm="3">DepartmentName</Form.Label>
                            <Col sm="9">
                                <Form.Control type="text" value={DepartmentName} onChange={this.changeDepartmentName} />
                            </Col>
                        </Form.Group>
                    </Modal.Body>
                    <Modal.Footer>
